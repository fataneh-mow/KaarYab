...
export default function UserDashboardPage() {
    ...
    return (
        ...
        >
            <section
                className="rounded-3xl bg-gradient-to-br from-slate-800 via-blue-900 to-indigo-950 p-8 text-white shadow-xl"
            >
                <p
                ...
                >
                    Manage your saved opportunities, explore new
                    opportunities, and track your activities.
                </p>
            </section>
